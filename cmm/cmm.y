...
compare:
    ...
    | FLAG_PO compare_com           { $$ = Compare("po", "?"); }
    | FLAG_PE compare_com           { $$ = Compare("pe", "?"); }
    | FLAG_P  compare_com           { $$ = Compare("p", "?"); }
    | FLAG_M  compare_com           { $$ = Compare("m", "?"); }
;
